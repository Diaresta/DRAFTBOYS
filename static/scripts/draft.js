        ...
        function pickCard() {
          if (cardImage.className == 'draftCards') {
            ...
            if (cardImage.name == 0) {
              ...
              packDiv1.removeChild(
                packCards1[randomNum(packDiv1.childElementCount)]
              );
              packDiv2.removeChild(
                packCards2[randomNum(packDiv2.childElementCount)]
              );
              packDiv3.removeChild(
                packCards3[randomNum(packDiv3.childElementCount)]
              );
              packDiv4.removeChild(
                packCards4[randomNum(packDiv4.childElementCount)]
              );
              packDiv5.removeChild(
                packCards5[randomNum(packDiv5.childElementCount)]
              );
              packDiv6.removeChild(
                packCards6[randomNum(packDiv6.childElementCount)]
              );
              packDiv7.removeChild(
                packCards7[randomNum(packDiv7.childElementCount)]
              );
            } else if (cardImage.name == 1) {
              // "Passing" packs | Styling pack divs
              packDiv1.style.display = 'none';
              ...
              // "Other players picking" cards | Randomly removing cards
              packDiv0.removeChild(
                packCards0[randomNum(packDiv0.childElementCount)]
              );
              packDiv2.removeChild(
                packCards2[randomNum(packDiv2.childElementCount)]
              );
            ...
            if (cardImage.name == 8) {
              ...
              // "Other players picking" cards | Randomly removing cards
              packDiv9.removeChild(
                packCards9[randomNum(packDiv9.childElementCount)]
              );
              packDiv10.removeChild(
                packCards10[randomNum(packDiv10.childElementCount)]
              );
              packDiv11.removeChild(
                packCards11[randomNum(packDiv11.childElementCount)]
              );
              packDiv12.removeChild(
                packCards12[randomNum(packDiv12.childElementCount)]
              );
              packDiv13.removeChild(
                packCards13[randomNum(packDiv13.childElementCount)]
              );
              packDiv14.removeChild(
                packCards14[randomNum(packDiv14.childElementCount)]
              );
              packDiv15.removeChild(
                packCards15[randomNum(packDiv15.childElementCount)]
              );
            } else if (cardImage.name == 9) {
              // "Passing" packs | Styling pack divs
              packDiv9.style.display = 'none';
              ...
              // "Other players picking" cards | Randomly removing cards
              packDiv8.removeChild(
                packCards8[randomNum(packDiv8.childElementCount)]
              );
              packDiv10.removeChild(
                packCards10[randomNum(packDiv10.childElementCount)]
              );
            ...
            if (cardImage.name == 16) {
              ...
              // "Other players picking" cards | Randomly removing cards
              packDiv17.removeChild(
                packCards17[randomNum(packDiv17.childElementCount)]
              );
              packDiv18.removeChild(
                packCards18[randomNum(packDiv18.childElementCount)]
              );
              packDiv19.removeChild(
                packCards19[randomNum(packDiv19.childElementCount)]
              );
              packDiv20.removeChild(
                packCards20[randomNum(packDiv20.childElementCount)]
              );
              packDiv21.removeChild(
                packCards21[randomNum(packDiv21.childElementCount)]
              );
              packDiv22.removeChild(
                packCards22[randomNum(packDiv22.childElementCount)]
              );
              packDiv23.removeChild(
                packCards23[randomNum(packDiv23.childElementCount)]
              );
            } else if (cardImage.name == 17) {
              // "Passing" packs | Styling pack divs
              packDiv17.style.display = 'none';
              ...
              // "Other players picking" cards | Randomly removing cards
              packDiv16.removeChild(
                packCards16[randomNum(packDiv16.childElementCount)]
              );
              packDiv18.removeChild(
                packCards18[randomNum(packDiv18.childElementCount)]
              );
